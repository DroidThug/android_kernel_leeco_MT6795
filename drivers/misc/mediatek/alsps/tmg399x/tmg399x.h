...
#define D_Factor1	 1453//5666
#define R_Coef1		 250//5
#define G_Coef1		1000
#define B_Coef1		720//452
...
enum tmg399x_caloffsetspeed {
	CAL_FAST,       //!< cal offset fast
	CAL_SLOW        //!< cal offset slow
};
...
extern struct tmg399x_parameters *get_tmg_arglist(void); //add 2014.6.20
