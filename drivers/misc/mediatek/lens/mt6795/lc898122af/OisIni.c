...
void	IniGyr( void )
{
	...
	RamWrite32A( gylmt4HS0, GYRLMT4_S1 ) ;				// 0x112B	YLimiter4 High?l0
	RamWrite32A( gxlmt4HS0, GYRLMT4_S1 ) ;				// 0x102B	XLimiter4 High?l0
	
	RamWrite32A( gxlmt4HS1, GYRLMT4_S2 ) ;				// 0x102C	XLimiter4 High?l1
	RamWrite32A( gylmt4HS1, GYRLMT4_S2 ) ;				// 0x112C	YLimiter4 High?l1
