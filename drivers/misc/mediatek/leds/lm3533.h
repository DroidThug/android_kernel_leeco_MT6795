...
extern int lm3533_resume_test(struct lm3533 *lm3533);
extern int  lm3533_device_init(struct lm3533 *lm3533);
extern void  lm3533_device_exit(struct lm3533 *lm3533);
extern void lm3533_enable(struct lm3533 *lm3533);
extern void lm3533_disable(struct lm3533 *lm3533);
extern int lm3533_set_hvled_config(struct lm3533 *lm3533, u8 hvled, u8 bl);
extern int lm3533_set_boost_ovp(struct lm3533 *lm3533, u8 boost_ovp);
