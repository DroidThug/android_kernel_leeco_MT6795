...
#define CAM_CAL_DEV_MAJOR_NUMBER 251

/* CAM_CAL READ/WRITE ID */
#define S5K3L8OTP_DEVICE_ID							0xA0

#define S5K3L8_AWBAF_OTP_SIZE 14
#define S5K3L8_LSC_OTP_SIZE 1868
#define S5K3L8_PDAF_OTP_SIZE 1404


typedef struct  s5k3l8_otp_struct{
	...
	kal_uint8 lsc_data[S5K3L8_LSC_OTP_SIZE];	//lsc_data 0x0017
	
	kal_uint8 pdaf_data[S5K3L8_PDAF_OTP_SIZE];	//pdaf_data 0x0763
